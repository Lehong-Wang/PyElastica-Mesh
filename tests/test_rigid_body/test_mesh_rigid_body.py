...
def run_all():
    tests = [
        test_MeshRigidBody_initialization,
        test_mesh_rigid_body_update_accelerations,
        test_compute_position_center_of_mass,
        test_compute_translational_energy,
        test_update_faces_translation,
        test_update_faces_rotation,
        test_update_faces_rotation_and_translation,
    ]
    for t in tests:
